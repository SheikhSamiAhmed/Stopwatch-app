...
// create a event for start the stop watch

    document.querySelector("#on").addEventListener("click", this.handleClickStart);
    this.handleClickStop = this.handleClickStop.bind(this);


    // create a event for stop the stop watch
    document.querySelector("#off").addEventListener("click", this.handleClickStop);
    this.handleClickReset = this.handleClickReset.bind(this);


    // create a event for Reset the stop watch
